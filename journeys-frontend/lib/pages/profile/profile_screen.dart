...
class _MyProfileScreen extends State<ProfileScreen> {
  ...
  Future<void> _fetchData() async {
    try {
      // Fetch both profile and user data concurrently
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: _profile!.photo != null
                                      ? DecorationImage(
                                          image: MemoryImage(base64Decode(_profile!.photo!)),
                              ...
                              Text(
                                _user!.username.isNotEmpty
                                    ? _user!.username[0].toUpperCase() + _user!.username.substring(1)
                                    : _user!.username, // Use username from UserModel
                                textAlign: TextAlign.center,
                              ...
                              _buildMenuItem(context, 'Languages: ${_profile!.languages ?? ''}'),
                              _buildMenuItem(context, 'Location: ${_profile!.location ?? ''}'),
